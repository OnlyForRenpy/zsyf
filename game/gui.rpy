...
define gui.interface_text_color = u'#888888'


## 字体和字体大小 #####################################################################

## 用于游戏内文本的字体。
define gui.text_font = "FZKTJW.TTF"

## 用于角色名称的字体。
define gui.name_text_font = "FZKTJW.TTF"

## 用于游戏外文本的字体。
define gui.interface_text_font = "FZKTJW.TTF"

## 普通对话文本的大小。
define gui.text_size = 23
define gui.text_color = "#eee"
define gui.text_outlines = [(absolute(2), "#444", absolute(0), absolute(0))]
...
## 用于标题菜单和游戏菜单的图像。
define gui.main_menu_background = "gui/开始界面.jpg"
define gui.game_menu_background = "gui/开始界面.jpg"
...
## NVL 模式背景窗口的背景边框。
define gui.nvl_borders = Borders(230, 100, 0, 0)

## Ren'Py 所显示的 NVL 模式条目的最大数量。如果要显示更多条目，则最早的条目将被删除。
