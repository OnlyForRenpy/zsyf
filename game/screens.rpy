...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("开始游戏") action ShowMenu("choseChapters")
...
screen choseChapters():
    ...
    viewport:
        ...
        vbox:
            ...
            textbutton _("一、  原文1章"):
                action Start("story_1_1")
            textbutton _("二、  原文2章"):
                action Start("story_2_1")
            textbutton _("三、  原文3章"):
                action Start("story_3_1")
            textbutton _("四、  原文4-5章"):
                action Start("story_4_1")
            textbutton _("五、  原文6-7章"):
                action Start("story_6_1")
            textbutton _("六、  原文8-9章"):
                action Start("story_8_1")
            textbutton _("七、  原文10-11章"):
    ...
    # textbutton _("一、  原文1"):
    #     # at prologue_button
    #     action Jump("story_1_1")
    #
    # textbutton _("二、  原文2"):
    #     action Jump("story_2_1")
        # at chapter1_button
